...
object Main {
  def main(args: Array[String]): Unit = {
    ...
    //val inputPath = "s3://dmg56-wine-quality-prediction/data/TrainingDataset.csv"
    //val outputPath = "s3://dmg56-wine-quality-prediction/models"
    ...
    val directoryPath = s"$outputPath/$modelVersion";
    model.save(directoryPath)
